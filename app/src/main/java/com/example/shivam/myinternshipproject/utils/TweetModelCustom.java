...
public class TweetModelCustom implements Identifiable,Comparator<TweetModelCustom> {
    ...
    public final com.twitter.sdk.android.core.models.Tweet quotedStatus;
    ...
    public final com.twitter.sdk.android.core.models.Tweet retweetedStatus;
    ...
    public TweetModelCustom(Coordinates coordinates, String createdAt, Object currentUserRetweet,
                 ...
                 com.twitter.sdk.android.core.models.Tweet quotedStatus, int retweetCount, boolean retweeted, com.twitter.sdk.android.core.models.Tweet retweetedStatus,
    ...
    @Override
    public int compare(TweetModelCustom tweetModelCustom, TweetModelCustom t1) {
        int fav_count1 = ((TweetModelCustom)tweetModelCustom).favoriteCount;
